<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JueSeEdit.aspx.cs" Inherits="EyouSoft.WEB.cgs.JueSeEdit" MasterPageFile="~/mp/Boxy.Master" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mt10">
        ...
        <tr>
            ...
            <td>
                ...
                <p style="line-height:30px;"><input type="checkbox" value="<%#Eval("Value") %>" name="chkPrivs1" id="chk_<%#Eval("Value") %>">&nbsp;&nbsp;<label for="chk_<%#Eval("Value") %>"><%#Eval("Text") %></label></p>
