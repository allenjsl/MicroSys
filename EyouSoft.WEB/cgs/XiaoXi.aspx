<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XiaoXi.aspx.cs" Inherits="EyouSoft.WEB.cgs.XiaoXi" Title="消息中心" MasterPageFile="~/mp/Cgs.Master" %>
...
<asp:Content ContentPlaceHolderID="PageBody" ID="PageBody1" runat="server">
    <div class="right_box">
        ...
        <div class="searchbox fixed">
            <form action="xiaoxi.aspx" method="get">
        ...
        <div class="tablelist-box mt10" style="">
            <table width="100%" id="liststyle">
                ...
                <asp:Repeater runat="server" ID="rpt">
                    <ItemTemplate>
                        <tr data-itemid="<%#Eval("XiaoXiId") %>" data-guanlianid="<%#Eval("GuanLianId") %>" data-status="<%#(int)Eval("Status") %>" class="table_tr_item">
                            <td align="center">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            chaKan: function(obj) {
                ...
                var _data = { editid: _$tr.attr("data-guanlianid") };
