<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YongHu.aspx.cs" Inherits="EyouSoft.WEB.cgs.YongHu" Title="用户管理-系统设置" MasterPageFile="~/mp/Cgs.Master" %>
...
<asp:Content ContentPlaceHolderID="PageBody" ID="PageBody1" runat="server">
    <div class="right_box">
        ...
        <div class="searchbox fixed">
            <form action="yonghu.aspx" method="get">
            <p>
                用户姓名：
