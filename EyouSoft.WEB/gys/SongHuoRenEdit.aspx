<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SongHuoRenEdit.aspx.cs" Inherits="EyouSoft.WEB.gys.SongHuoRenEdit" MasterPageFile="~/mp/Boxy.Master" %>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            yangZhengForm: function() {
                if ($.trim($("#<%=txtName.ClientID %>").val()).length < 1) { alert("请输入姓名"); return false; }
