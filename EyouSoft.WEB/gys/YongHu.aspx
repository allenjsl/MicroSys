<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YongHu.aspx.cs" Inherits="EyouSoft.WEB.gys.YongHu" Title="用户管理-系统设置" MasterPageFile="~/mp/Gys.Master" %>
    ...
    <div class="right_box">
        ...
        <div class="searchbox fixed">
            <p>
                ...
                所属部门：
                <input type="text" class="formsize80 input-txt" id="txtBuMen" name="txtBuMen" />
