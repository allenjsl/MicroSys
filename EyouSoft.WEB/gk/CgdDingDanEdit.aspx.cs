...
namespace EyouSoft.WEB.gk
{
    ...
    /// 采购订单-编辑
    /// </summary>
    public partial class CgdDingDanEdit : GkYeMian
    {
        #region 
        /// <summary>
        /// 订单编号
        ...
        void InitInfo()
        {
            ...
            ltrCaiGouRenName.Text = info.CaoZuoRenName;
            ...
            ltrCaoZuo.Text = info.Status.ToString();//_caoZuo;
        }
        ...
        void QueRenShouHuo()
        {
            ...
            info.DaoHuoTime = Utils.GetDateTime(Utils.GetFormValue(txtShiJiDaoHuoTime.UniqueID));
