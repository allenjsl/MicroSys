...
namespace EyouSoft.WEB.gk
{
    ...
    /// 用户信息编辑
    /// </summary>
    public partial class YongHuEdit : GkYeMian
    {
        #region attributes
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (Utils.GetQueryStringValue("dotype"))
            {
                ...
                case "getgongsijuese": GetGongSiJueSe(); break;
                default: break;
            }
        ...
        void InitInfo()
        {
            ...
            txt_gongsi_id.Value = info.GongSiId;
            txt_gongsi_name.Value = info.GongSiName;
        ...
        EyouSoft.Model.MYongHuInfo GetFormInfo()
        {
            ...
            info.GongSiId = T == YongHuLeiXing.平台 ? YongHuInfo.GongSiId : Utils.GetFormValue(txt_gongsi_id.UniqueID);
        ...
        void InitJueSe()
        {
            if (T != YongHuLeiXing.平台 && string.IsNullOrEmpty(GongSiId)) return;

            if (T == YongHuLeiXing.平台) GongSiId = YongHuInfo.GongSiId;

            var chaXun = new EyouSoft.Model.MYongHuJueSeChaXunInfo();
            chaXun.GongSiId = GongSiId;

            if (T == YongHuLeiXing.平台) chaXun.GongSiId = YongHuInfo.GongSiId;
        ...
        void GetGongSiJueSe()
        {
            ...
            if (string.IsNullOrEmpty(chaXun.GongSiId)) Utils.RCWE("[]");
            var items = new EyouSoft.BLL.BYongHuJueSe().GetJueSes(chaXun);
